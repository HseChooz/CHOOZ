...
enum Colors {
    ...
    enum Neutral {
        ...
        static let grey99 = Color("grey99", bundle: .module)
    }
    ...
    enum Green {
        ...
        static let green1B = Color("green1B", bundle: .module)
        static let greenC9 = Color("greenC9", bundle: .module)
        static let greenEF = Color("greenEF", bundle: .module)
    }
