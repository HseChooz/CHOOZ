...
struct NotesLoadedView: View {
    ...
    init(model: Model, eventsHandler: NotesLoadedViewEventsHandler) {
        self.model = model
    ...
    private let eventsHandler: NotesLoadedViewEventsHandler
