...
extension ChoozAPI {
  class MainTabUpcomingEventQuery: GraphQLQuery {
    static let operationName: String = "MainTabUpcomingEvent"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MainTabUpcomingEvent { events(onlyUpcoming: true, limit: 1) { __typename id title description link notifyEnabled repeatYearly date } }"#
      ))
    ...
    struct Data: ChoozAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        MainTabUpcomingEventQuery.Data.self
      ] }
      ...
      struct Event: ChoozAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          MainTabUpcomingEventQuery.Data.Event.self
        ] }
