...
## Инструкции
Все файлы AGENT.md и README.md (не только корневые, но и вложенные) можно редактировать только по согласованию с пользователем, то есть перед внесением правок необходимо получить разрешение.
