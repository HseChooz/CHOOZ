...
## Инструкции
Все файлы маркдаун (не только корневые, но и вложенные), то есть с расширением .md, можно редактировать только по согласованию с пользователем, то есть перед внесением правок необходимо получить разрешение.
...
## Прочее
Изучи локальный файл AGENTS.local.md, если таковой имеется.
