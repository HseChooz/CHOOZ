...
@strawberry.type
class Query(AuthQuery, WishItemsQuery, NotesQuery, EventsQuery, CollectionsQuery):
    pass


@strawberry.type
class Mutation(AuthMutation, WishItemsMutation, NotesMutation, EventsMutation, CollectionsMutation):
    pass
